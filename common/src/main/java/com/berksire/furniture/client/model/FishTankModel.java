...
public class FishTankModel extends HierarchicalModel<ActualFishTankEntity> {
    ...
    @Override
    public void setupAnim(ActualFishTankEntity entity, float f, float g, float h, float i, float j) {
